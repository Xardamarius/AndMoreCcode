...
void CreateLevel(int lvl)
{
    ...
    if (lvl == 2)
    {
        ...
        brick = realloc( brick, sizeof(*brick) * brickLength );
        InitObject(GetNewBrick(), 20, 20, 40, 5, '#');
        InitObject(GetNewBrick(), 40, 15, 10, 10, '#');
        InitObject(GetNewBrick(), 60, 20, 20, 5, '#');
        InitObject(GetNewBrick(), 80, 20, 20, 5, '#');
        InitObject(GetNewBrick(), 100, 20, 20, 5, '#');
        InitObject(GetNewBrick(), 120, 15, 10, 10, '#');
        InitObject(GetNewBrick(), 140, 20, 40, 5, '#');
        InitObject(GetNewBrick(), 180, 15, 20, 1, '+');
    ...
    if (lvl == 3)
    {
        ...
        brick = realloc( brick, sizeof(*brick) * brickLength );
        InitObject(GetNewBrick(), 20, 20, 40, 5, '#');
        InitObject(GetNewBrick(), 40, 20, 15, 5, '#');
        InitObject(GetNewBrick(), 60, 20, 15, 5, '#');
        InitObject(GetNewBrick(), 80, 20, 15, 5, '#');
        InitObject(GetNewBrick(), 100, 15, 15, 10, '#');
        InitObject(GetNewBrick(), 120, 15, 15, 10, '#');
        InitObject(GetNewBrick(), 140, 15, 15, 10, '#');
